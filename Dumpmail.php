...
| Dumpmail.php
----------------------------------------------------------------------
| This is the library you can use to restrict the allowance of dump emails (Disposable emails).
| It contains around 1400 disposable email domains.
| It accepts the parameter in the form of string and returns the boolean true or false.
| 
| How to use,
| 1.	First load the library (I'm assuming you have already place this file in your codeigniters 
|		project directory /var/www/html/Codeigniter/application/libraries).
|		Syntax to load library
|			$this->load->library('dumpmail');
| 2. 	Validate email.
|		$this->dumpmail->validate(String);
| 		Eg.: $this->dumpmail->validate('myemail@myhost.in');
*/
...
"zxcxc.com"
				...
				$mailinfo = explode('@',$email,2);
				$domain = $mailinfo[1];
				if(!in_array($domain,$dumpmaillist)){
					return TRUE;
				}else{
					return FALSE;
				}
